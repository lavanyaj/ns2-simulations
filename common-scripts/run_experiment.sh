...
function set_env_vars {
    ...
    export PERC_DIR="${HOME_DIR}/tmp/ns2-simulations"
...
# "SCHEME=sperc;TOPOLOGY_TYPE=b4;NUM_SERVERS=18;FLOWS_PER_SERVER=100;LINK_RATE=10;EPOCH=4;NUM_EPOCHS=11;DUR=0.01;KW=\"b4-100G-1500KB\""
