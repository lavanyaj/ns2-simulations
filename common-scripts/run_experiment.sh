...
function set_env_vars {
    ...
    export PERC_DIR="${HOME_DIR}/tmp/perc/ns2-simulations"
    export PERC_COMMON="$PERC_DIR/common-scripts"

    export PERC_WATERFILLING_CT_BINARY="${HOME_DIR}/tmp/waterfilling/wsim-ct"
...
function setup_for_ct {
    ...
    declare -a CONFIGS=(  
"SCHEME=sperc;TOPOLOGY_TYPE=spine-leaf;NUM_SERVERS=144;FLOWS_PER_SERVER=20;LINK_RATE=100;EPOCH=0.002;NUM_EPOCHS=11;DUR=0.00001;KW=\"c4-h2-mt20\";FRAC_REPLACE=0.4"
"SCHEME=sperc;TOPOLOGY_TYPE=b4;NUM_SERVERS=18;FLOWS_PER_SERVER=100;LINK_RATE=1;EPOCH=4;NUM_EPOCHS=11;DUR=0.01;FRAC_REPLACE=0.7;KW=b4-1G-1500B-j0;"
"SCHEME=sperc;TOPOLOGY_TYPE=b4;NUM_SERVERS=18;FLOWS_PER_SERVER=100;LINK_RATE=10;EPOCH=4;NUM_EPOCHS=11;DUR=0.01;FRAC_REPLACE=0.4;KW=\"b4-10G-1500B-j0\""
"SCHEME=rcp;TOPOLOGY_TYPE=spine-leaf;NUM_SERVERS=144;FLOWS_PER_SERVER=20;LINK_RATE=100;EPOCH=0.01;NUM_EPOCHS=11;DUR=0.00001;KW=\"spineleaf-100G-86pkt-a0.4b0.2-mr150000\";FRAC_REPLACE=0.4"
"SCHEME=rcp;TOPOLOGY_TYPE=b4;NUM_SERVERS=18;FLOWS_PER_SERVER=100;LINK_RATE=10;EPOCH=10;NUM_EPOCHS=11;DUR=0.01;FRAC_REPLACE=0.4;KW=172pkt-a0.9b0.1-mr150000-prb100ms-i0.02"
"SCHEME=rcp;TOPOLOGY_TYPE=b4;NUM_SERVERS=18;FLOWS_PER_SERVER=100;LINK_RATE=1;EPOCH=10;NUM_EPOCHS=11;DUR=0.01;FRAC_REPLACE=0.7;KW=172pkt-a0.9b0.1-mr15000-prb100ms-i0.02" 
)
