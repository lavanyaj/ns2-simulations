...
# installed.
TCL_PREFIX='/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/tcl8.4.18/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/include'
...
# compiled.
TCL_SRC_DIR='/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/tcl8.4.18'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/tcl8.4.18/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/tcl8.4.18/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/lavanya_jose/sigcomm18-code/fct-simulations/ns2-dctcp/lib/libtclstub8.4${TCL_DBGX}.a'
